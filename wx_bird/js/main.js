import Phaser from './libs/gamelibs/phaser-wx.js'
...
export default class Main{
  ...
  constructor(){
    ...
    var textStyle2 = { font: "36px Arial", fill: "#FFFFFF", align: "center" };
    ...
    game.States.preload = function () {
      this.preload = function () {
        ...
        // game.load.bitmapFont('flappy_font', 'fonts/flappyfont/flappyfont.png', 'fonts/flappyfont/flappyfont.fnt');
        game.load.audio('fly_sound', 'audio/flap.wav');
        game.load.audio('score_sound', 'audio/score.wav');
        game.load.audio('hit_pipe_sound', 'audio/pipe-hit.wav');
        game.load.audio('hit_ground_sound', 'audio/ouch.wav');
    ...
    game.States.play = function () {
      this.create = function () {
        ...
        this.scoreText = game.add.text(game.world.centerX - 20, 30, '0', textStyle2);
      ...
      this.showGameOverText = function () {
        ...
        var currentScoreText = game.add.text(game.width / 2 + 60, 128, this.score + '', textStyle);
        var bestScoreText = game.add.text(game.width / 2 + 60, 176, game.bestScore + '', textStyle);
